...
class TaskAlignedAssigner(nn.Module):
    ...
    def get_box_metrics(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes, mask_gt):
        ...
        # Area-aware weighting for small objects (safe variant: keep IoU semantics intact)
        ...
        align_metric = bbox_scores.pow(self.alpha) * overlaps.pow(self.beta) * area_weight.pow(gamma)
